  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        pursue my passion for programming. I started a coding bootcamp and
        ...
        using something that I have learned to solve to a problem that I
        couldn&apos;t before. My core stack is{" "}
        <span className="font-medium">
          Angular, Java, Spring, and PostgresSQL
        </span>
        . I am also comfortable with TypeScript, Python and React. I am always
      ...
      <p>
        ...
        playing hiking, climbing, and spending time with friends and family. I
        also enjoy <span className="font-medium">learning new things</span>. I
        am currently learning about{" "}
        <span className="font-medium">Artificial Intelligence</span>. I&apos;m
