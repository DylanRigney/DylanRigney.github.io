...
const Scene = () => {
  ...
  return (
    <>
      ...
      {Object.values(cards).map((bounds) => (
        <SyncedGlassPanel key={bounds.id} bounds={bounds} />
      ))}
    </>
  );
};

export const LiquidGlassCanvas = () => {
  return (
    <div className="fixed inset-0 pointer-events-none z-[-1] bg-[#050608]">
      <Canvas
